...
- Node 专项回归覆盖：3 / 8 / 28 获得、0–100 限制、2.5 秒延迟衰减、轻触/短蓄/失败回退、敌人同帧生成攻击在碰撞前偏转且不回补耐久、投射物与军刀单次偏转、炮击和 Boss 全屏排除、28/35 锁定与 35/35 READY、35 点消耗、2.2 倍伤害、至少 3 层贯穿、3 秒过期不扣除、输入清理、schema 7 不变、非先锋/非 OG-04 回归、设施命中、通讯单次触发、四状态映射和 OG-04 空间层契约。
...
- 关闭闸门：`qa-artifacts/4.4A-og04-exit-closed-844x390.png`
- 开启闸门：`qa-artifacts/4.4A-og04-exit-open-844x390.png`
- 四处实体碰撞障碍：`qa-artifacts/4.4A-og04-spatial-obstacles-844x390.png`
